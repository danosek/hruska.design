...
const particleColors = [0x884b16, 0xf6e7da, 0xd76909, 0xe7ac79, 0x5a74f6, 0x97a5ed, 0x97a5ed, 0x97a5ed, 0x97a5ed, 0x97a5ed, 0xc4ccf3, 0xc4ccf3, 0xc4ccf3, 0xc4ccf3, 0xc4ccf3, 0xe2e6f8, 0xe2e6f8, 0xe2e6f8]
...
for (let i = 0; i < particlesCount2; i++) {
    ...
    positions2[i * 3 + 0] = (Math.random() - 0.5) * 10 // X
...
const ambientLight = new THREE.AmbientLight("#353c5f", 0.5)
